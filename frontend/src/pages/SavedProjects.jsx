...
export default function SavedProjects() {
  ...
  const deleteProject = async (projectId, projectName) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/defi/projects/${projectId}`, {
        method: 'DELETE'
      });
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      {/* Notification */}
      {notification && (
        <div className={`fixed top-24 right-6 z-50 px-6 py-4 rounded-xl border backdrop-blur-xl animate-slide-down ${
          ...
          <div className="bg-[#0a0e14] border border-red-500/30 rounded-2xl p-8 max-w-md w-full">
            <div className="text-center">
              ...
              <p className="text-white/60 mb-6">
                This will permanently delete all {projects.length} protocols and their historical data. 
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-white/60">
            Browse and filter your analyzed DeFi protocols
          </p>
        </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-white/60">Audit Status</span>
                <span className={`text-sm font-medium ${
                  project.audit_status === 'Audited' ? 'text-green-400' : 'text-orange-400'
                }`}>
              ...
              <div>
                <div className="flex items-center justify-between text-sm text-white/60 mb-2">
                  ...
                  <span className="text-white font-medium">{project.risk_score.toFixed(1)}</span>
                </div>
